            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1 pt-4">
                ...
                <div className="flex items-center gap-2 mt-4">
                  ...
                  <div className="flex gap-2">
                    <span className="px-3 py-1 bg-purple-100 text-purple-600 rounded-full text-sm">기타</span>
                    <span className="px-3 py-1 bg-purple-100 text-purple-600 rounded-full text-sm">드럼</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div
              className={`transition-opacity duration-200 ${
                activeTab === 'uploaded' ? 'opacity-100' : 'opacity-0 absolute inset-0'
              }`}
            >
            ...
            <div
              className={`transition-opacity duration-200 ${
                activeTab === 'liked' ? 'opacity-100' : 'opacity-0 absolute inset-0'
              }`}
            >
